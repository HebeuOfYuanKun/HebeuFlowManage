...
public class MyUserDetailsService implements UserDetailsService {
    ...
    //查找权限
    public List<GrantedAuthority> ProdeceAuthority(Integer id){//查询权限方法，并返回security框架所需要的权限列表
        String Authority=authorityService.QueryAuthorityById(id);//查询用户的权限列表
